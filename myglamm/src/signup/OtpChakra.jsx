import { Button, Modal, ModalOverlay, ModalContent, useDisclosure,ModalCloseButton,ModalBody,Input, ModalFooter,Image,Text,Box,
  PinInputField,
  PinInput,
...
function OtpCheker({onClickClose}) {
...
const handleSubmit=()=>{
  ...
  return (
    <>
      ...
      >
        <ModalOverlay />
        <ModalContent height={"650px"} width={"650px"}>
          <Box marginTop="20px">
          ...
          <Image
            ...
            width="200px"
            src="https://files.myglamm.com/site-images/original/mob-otp_1.png"
          ></Image>
          <Text
            marginLeft="40%"
            paddingBottom="value"
