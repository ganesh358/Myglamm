...
import '../App.css';
import {  Flex,Box, Spacer, Heading, Text, VStack} from '@chakra-ui/react'
...
export const MenuBar = () => {
  return (
    <Flex width='75%'  margin='auto'  ml='2.9rem'>

        <Box fontFamily="Roboto" className="dropdown">
            <Link to={"/"} ><Box className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'> HOME </Box></Link>
        </Box>
        <Spacer/>  
        ...
        <Box  fontFamily="Roboto" className="dropdown">
           ...
           <Link to="/makeup"><Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600' >MAKEUP</Box></Link>
...
{/* 3     Dropdown */}
        <Box  fontFamily="Roboto" className="dropdown">
        <Link to="/haircare"><Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>HAIRCARE</Box></Link>
...
{/* 4    Dropdown  */}
        <Box  fontFamily="Roboto" className="dropdown">
        <Link to="/skincare"><Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>SKINCARE</Box></Link>
   ...
   {/* 5      Dropdown          */}
        <Box  fontFamily="Roboto" className="dropdown">
        <Link to="/sanitising"><Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>SANITIZING CARE</Box></Link>
...
{/* 6       Dropdown           */}
        <Box  fontFamily="Roboto" className="dropdown">
        <Link to="/collection"> <Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>COLLECTION</Box></Link>
...
{/* 7    Dropdown              */}
        <Box  fontFamily="Roboto" className="dropdown">
            <Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>REWARDS</Box>
...
{/* 8      Dropdown          */}
        <Box  fontFamily="Roboto" className="dropdown">
            <Box  className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>MYGLAMM STUDIO</Box>
...
{/* 9    Drop down            */}
        <Box className="dropdown">
            <Box fontFamily="Roboto" className="dropbtn" color='blackAlpha.800'  fontSize='.79rem' fontWeight='600'>OFFERS</Box>
