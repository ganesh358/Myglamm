import {Box, Center,useColorModeValue,Heading, Text,Stack,Image } from '@chakra-ui/react';
  ...
  // const IMAGE=  'https://files.myglamm.com/site-images/400x400/Game-over-Germs_2.jpg';
  
  export default function CollectionCards({image,name}) {
    return (
      <Center py={10}>
        <Box role={'group'} p={6}  maxW={'220px'} w={'full'} bg={useColorModeValue('white', 'gray.800')} border='2px'
